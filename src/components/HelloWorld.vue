<template>
  <v-container>
    <v-layout row wrap>
      <v-flex xs12 md4>
        <div class="mx-3 grey lighten-1 pa-5">
          <div class="loader">
            ...
            <svg viewBox="-3 -3 106 106" style="display: block; width: 100%;" class="circular-loader">
              ...
              <path d="M 50,50 m 0,-47.5 a 47.5,47.5 0 1 1 0,95 a 47.5,47.5 0 1 1 0,-95" stroke="#F4511E" stroke-width="9" fill-opacity="0" class = "xpath" style="stroke-dasharray: 300, 300; stroke-dashoffset: 255;"></path>
            </svg>
      ...
      <v-flex xs12 md4>
        <div class="mx-3 deep-purple darken-3 pa-5"></div>
      </v-flex>
      <v-flex xs12 md4>
        <div class="mx-3 white pa-5"></div>
      </v-flex>
    </v-layout>
  </v-container>
</template>
